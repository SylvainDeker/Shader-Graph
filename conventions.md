# Coding conventions for Shader-Graph

Mainly inspired by https://github.com/STORM-IRIT/Radium-Engine

## Headers

* Every .cpp must have an associated .hpp file
* use .inl files for inline functions definitions and include it in the .hpp
* All headers should have include guards in the form `#ifndef HEADER_NAME_HPP`
...
* Use `namespace ShaderGraph { }` for all ShaderGraph code.
