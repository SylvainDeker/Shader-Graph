...
// TODO : put here the list of each of node

// see -- https://docs.unrealengine.com/en-US/Engine/Rendering/Materials/ExpressionReference
...
namespace ShaderGraph
{
    ...
    public:
        ...
        inline void setNodeStyle(const QString& codeStyle) const
        {
